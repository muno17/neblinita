...
layout = [[sg.Text('neblina', font=('Monaco', 30), pad=(5,5)), sg.Text('            muno audio', font=('Monaco', 20))],
        ...
        [sg.Slider((0.00,1.00), key='-WET_DRY-', orientation='v', resolution=.01, enable_events=True, disable_number_display=True, pad=(15,0), border_width=2, font='Monaco'),],
        [sg.Text(text='   wet/dry', font='Monaco')]]
